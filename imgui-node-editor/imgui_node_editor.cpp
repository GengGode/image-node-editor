...
{
    const bool isDefault = m_StartPin && m_StartPin->m_Dir != ImVec2(1.0f, 0.0f) || m_EndPin && m_EndPin->m_Dir != ImVec2(-1.0f, 0.0f) || !m_EndPin || !m_EndPin->m_Node || !m_StartPin || !m_StartPin->m_Node;

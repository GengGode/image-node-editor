...
static std::vector<std::pair<std::string, factory_func_t>> Win32SoftInputNodesFactorys = {
    {"Win32/鼠标点击类型枚举", Spawn_EnumMouseClickTypeNode},
    {"Win32/鼠标点击动作枚举", Spawn_EnumMouseClickActionTypeNode},
    {"Win32/键盘控制类型枚举", Spawn_EnumKeyContorlTypeNode},
    {"Win32/键盘按键动作枚举", Spawn_EnumKeyClickActionTypeNode},
    {"Win32/软件/鼠标点击", Spawn_Win32_SoftInput_MouseClick},
    {"Win32/软件/鼠标移动", Spawn_Win32_SoftInput_MouseMove},
    {"Win32/软件/鼠标滚轮", Spawn_Win32_SoftInput_MouseWheel},
    {"Win32/软件/键盘点击", Spawn_Win32_SoftInput_KeyClick},
    {"Win32/后台/鼠标点击", Spawn_Win32_PostMessage_MouseClick},
    {"Win32/后台/鼠标移动", Spawn_Win32_PostMessage_MouseMove},
    {"Win32/后台/鼠标滚轮", Spawn_Win32_PostMessage_MouseWheel},
    {"Win32/后台/键盘点击", Spawn_Win32_PostMessage_KeyClick},
};